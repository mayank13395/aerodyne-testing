...
let productsarr = $('.owl-stage').children();
    
   let centerProduct = $(productsarr.eq(event.item.index ));
   // // console.log("centerProduct",$(centerProduct['0']).find('.product-section-content'));
   $(centerProduct['0']).find('.product-section-content').show();
   
productsarr.each(product => {
// // console.log(product,event.item.index);
if(product != event.item.index){
	$(productsarr.eq(product )['0']).find('.product-section-content').hide();
}
...
---------------------------------------------------------------------------------------------*/
    ...
    function color_fill_header() {
        ...
        if(scroll >= 650) {
            $(".my-nav").addClass("my-nav-background");
            $(".icon-bar").addClass("mobile-nav-color");
        } else {
            $(".my-nav").removeClass("my-nav-background");
            $(".icon-bar").removeClass("mobile-nav-color");
        }
    }
